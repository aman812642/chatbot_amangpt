        ...
        <div className="main-container">
          {!showResult ? (
            <>
              <div className="greet">
                <p>
                  <span>Hello, Sir/Madam</span>
                </p>
                <p>How can I help you today?</p>
              </div>
              <div className="cards">
                <div className="card">
                  <p>Suggest beautiful places in india to visit in monsoon</p>
                  <img src={assets.compass_icon} alt="CompassIcon" />
                </div>
                <div className="card">
                  <p>Fun facts about web developers and software developers</p>
                  <img src={assets.bulb_icon} alt="CompassIcon" />
                </div>
                <div className="card">
                  <p>Daily routine for summers vaction as a student</p>
                  <img src={assets.message_icon} alt="CompassIcon" />
                </div>
                <div className="card">
                  <p>Improve code readabilty</p>
          ...
          <div className="main-bottom">
            ...
            <p className="bottom-info">
              AmanGpt may display inaccurate info, including about people, so
              double-check its responses , all responses comes for google gemini chat bot.{" "}
